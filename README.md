...
- **Comprehensive Audit:** Checks entire commit history, including deleted files.
- **Environment Validation:** Automatically checks that Git is installed and you're in a valid repository before starting.
- **Smart Error Handling:** Clear, actionable error messages guide you through any issues.
- **Private Repository Support:** Detects private repositories and guides you to use the correct authentication method.
- **Batch Processing:** Audit multiple repositories from a CSV file with progress tracking.
